...
// node_modules/react-spin-game/dist/index.modern.js
...
function SvgWheelArrow(props) {
  return (0, import_react.createElement)("svg", _extends({
    ...
    width: 12.922,
    height: 14.48
  }, props), _defs || (_defs = (0, import_react.createElement)("defs", null, (0, import_react.createElement)("clipPath", {
    ...
    fill: "#a72810"
  })))), _g || (_g = (0, import_react.createElement)("g", {
...
var SpinAndWin = (0, import_react.forwardRef)(function(_ref, ref) {
  var data = _ref.data, hideButton = _ref.hideButton, result = _ref.result, time = _ref.time, minTime = _ref.minTime, maxTime = _ref.maxTime, removeButtonEffect = _ref.removeButtonEffect, fontSize = _ref.fontSize, fontFamily = _ref.fontFamily, horizantalText = _ref.horizantalText;
  var wheelRef = (0, import_react.useRef)();
  ...
  var degToRad = function degToRad2(deg) {
    return deg * Math.PI / 180;
  };
  var drawWheel = function drawWheel2(list, wheel, wheelX, wheelY, wheelRadius) {
  ...
  (0, import_react.useImperativeHandle)(ref, function() {
    return {
      handleSpin: function handleSpin2() {
        var wheelCanvas = document.getElementById("wheel");
        if (wheelCanvas) {
  ...
  var handleSpin = function handleSpin2() {
    var wheelCanvas = document.getElementById("wheel");
    if (wheelCanvas) {
      var freeSpinResult = result ? result : "23454";
      var transitionTime = time ? time : minTime && maxTime && minTime > 0 && maxTime > 0 ? Math.floor(Math.random() * (maxTime - minTime + 1)) + minTime : Math.floor(Math.random() * (4 - 3 + 1)) + 3;
  ...
  return import_react.default.createElement("div", null, import_react.default.createElement("div", {
    ...
    width: "450px",
    height: "450px"
  }), !hideButton && import_react.default.createElement("span", {
    className: Styles["spin"],
    onClick: function onClick() {
      return removeButtonEffect ? "" : handleSpin();
    }
  }, "SPIN")), import_react.default.createElement("span", {
    className: Styles["arrow"]
  }, import_react.default.createElement(SvgWheelArrow, null))));
});
var index_modern_default = SpinAndWin;
export {
  index_modern_default as default
};
//# sourceMappingURL=react-spin-game.js.map
